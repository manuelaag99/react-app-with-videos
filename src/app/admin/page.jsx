...
export default function AdminPage () {
    ...
    return (
        <div>
            <TopNavigationBar />
            <div className="flex flex-col sm:flex-row sm:w-85percent w-95percent mx-auto justify-center bg-white rounded-md sm:mt-40 mt-20 mb-28 pb-16 pt-7 px-7 shadow-2xl">
