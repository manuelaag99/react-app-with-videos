...
export default function CreateContentPopUp ({ content, onClose, open }) {
    const createContentPopUp = (
        <div>
            ...
            <div className="flex flex-col justify-center fixed w-9/10 sm:w-6/10 h-6/10 bg-white rounded-md shadow-2xl left-[5%] sm:left-[20%] z-40 p-4 sm:p-9 ">
                ...
                <div className="flex flex-col mx-auto w-95percent my-6">
                ...
                <Button additionalClassNamesForButton=" w-95percent py-3 bg-var-2 hover:bg-var-2-hovered duration-200 mx-auto rounded-sm" additionalClassNamesForText=" text-white text-button-desktop font-amatic font-bold" contentForButton="Crear" onClickButtonAction={() => console.log("click")} />
            </div>
        </div>
    );
