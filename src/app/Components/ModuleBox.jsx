...
export default function ModuleBox ({ index, moduleId }) {
    ...
    if (!moduleInfo) {
        ...
        return (
            <div className="flex sm:flex-row flex-col justify-center w-full py-5 px-6 hover:bg-gray-300 shadow-lg duration-300" onClick={() => router.push("/courses/" + moduleInfo.course_id + "/" + moduleInfo.module_id)} key={index}>
                ...
                <div className="flex flex-row sm:flex-col justify-start items-start w-full sm:w-7/10 sm:pl-6">
                    ...
                    <div className="sm:hidden flex justify-end items-center w-1/10 ">
                        <button>
                            <MoreVertIcon />
                        </button>
                    </div>
