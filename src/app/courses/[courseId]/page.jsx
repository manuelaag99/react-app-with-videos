            ...
            <div className="flex w-9/10 mx-auto justify-center bg-white rounded-md mt-14">
                <div className="flex flex-row w-full">
                    <div className="flex flex-col w-1/2 px-5 py-7 items-center">
                        <div className="flex">
                            <div className="flex w-full py-2 font-bold">{courseModules.course_title}</div>
                            <div className="flex w-full py-2">{courseModules.course_description}</div>
                        </div>
