	...
	return (
		...
		<div className="flex sm:flex-row flex-col w-full bg-white px-6 py-9 shadow-lg">
			<div className="flex flex-col sm:w-6/10 w-full pr-6">
				<div className="font-amatic font-bold text-sign-in-or-sign-up-title-desktop -mt-2">Cursos de repostería</div>
				<div></div>
				<div>
		...
		<div className="flex sm:flex-row flex-col w-full bg-var-4 shadow-lg mb-10">
			...
			<div className="flex flex-col sm:w-6/10 w-full px-6 py-9">
				<div className="font-amatic font-bold text-sign-in-or-sign-up-title-desktop -mt-2">Hacer un pedido</div>
				<div></div>
			</div>
