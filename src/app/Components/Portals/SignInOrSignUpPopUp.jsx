...
export default function SignInOrSignUpPopUp ({ onClose, open, openSignUp }) {
    ...
    const signInOrSignUpPopUp = (
        <div>
            ...
            <div className={"flex flex-col justify-center fixed w-9/10 sm:w-6/10 h-6/10 bg-white rounded-md shadow-2xl left-[5%] sm:left-[20%] z-40 p-4 sm:p-9 " + (isSignUp ? " top-[5%] " : " top-[18%] ")}>
