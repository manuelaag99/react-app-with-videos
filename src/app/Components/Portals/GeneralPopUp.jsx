            ...
            <div className="flex flex-col justify-center fixed w-7/10 sm:w-5/10 h-fit bg-white rounded-md shadow-2xl left-[15%] sm:left-[25%] top-[25%] z-50 p-4 sm:p-9 ">
                <div className="flex flex-col w-full px-6 justify-center items-center h-fit">
                    ...
                    <div className="flex flex-col sm:flex-row w-full justify-between">
                        {(infoForPopUp !== "") && <Button additionalClassNamesForText=" text-center" additionalClassNamesForButton=" bg-var-1 text-white bg-var-1-hovered duration-200 rounded-md shadow-md sm:mb-0 mb-4" contentForButton={infoForPopUp.textForButtonOne} onClickButtonAction={onClose} />}
