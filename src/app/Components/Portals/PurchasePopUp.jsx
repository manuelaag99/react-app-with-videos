        ...
        <div className="h-full">
            ...
            <div className="flex flex-col justify-center w-6/10 h-fit bg-white shadow-2xl fixed rounded-md z-30 mx-auto top-[15%] left-[20%] p-5 ">
                ...
                <div className="flex flex-row justify-between px-6 py-3">
                    <Button additionalClassNamesForButton=" text-center -mt-1.5 -mb-1.5" additionalClassNamesForText=" flex justify-center md:mt-0 mt-3 px-4 py-2 font-amatic text-button-desktop font-bold rounded-md shadow-md bg-var-2 hover:bg-var-2-hovered duration-300 text-white" contentForButton="Si, comprar curso" isDisabled={false} onClickButtonAction={registerPurchaseInDatabase} />
